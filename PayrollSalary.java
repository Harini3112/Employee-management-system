...
public class PayrollSalary extends JFrame implements ActionListener{
	...
	private JTextField salaryField;
	 static String lid1;
	 static String sal1,ins1,mail1;
		static String namenow1;

    PayrollSalary(String lid,String namenow){
    	//System.out.print("balue");
    	setVisible(true);
    	lid1=lid;
    	namenow1=namenow;
        	...
        	public void actionPerformed(ActionEvent e) {
        		try{
                    ...
                    System.out.println("before if");
                        ...
                        //double hra = rs.getDouble("144");
                        double hra = 40.8;
                        t1.append("\n                  HRA         : "+hra);
                        //double da  = rs.getDouble("45");
                        double salarydb = Integer.parseInt(sal1);
                        System.out.print(sal1);
                        
                        double da = 0.4*Integer.parseInt(sal1);
                        t1.append("\n                  DA          : "+da);
                        //double med  = rs.getDouble("436");
                        double ins=Integer.parseInt(ins1);
                        //double ins = (double)insure;
                        t1.append("\n                  INSURANCE         : "+ins);
                        
                        //double pf  = rs.getDouble("123");
                        double pf = 0.2*Integer.parseInt(sal1);
                        t1.append("\n                  PF          : "+pf);
                        //double basic = rs.getDouble("Initial_Password");
    ...
    public static void main(String[] args){
		...
		//new PayrollSalary(lid1,namenow1);
